...
const card = (on: boolean): React.CSSProperties => ({
  ...
  userSelect: "none", WebkitUserSelect: "none" as const, touchAction: "manipulation",
});
      ...
      <main className="main">
        ...
        <div className="content">
          <div className="form-wrap">
            ...
            {/* 01 Currency */}
            <div className="field">
              <div style={lbl}>01 — Investment currency</div>
            ...
            {/* 02 Amount */}
            <div className="field">
              <div style={lbl}>02 — Amount to invest</div>
              <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
                <span style={{ fontSize: 16, fontWeight: 600, color: "#4a506b" }}>{currencySymbol}</span>
            ...
            {/* 03 Horizon */}
            <div className="field">
              <div style={lbl}>03 — Investment horizon</div>
              <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
                <input className="amount-input" type="text" inputMode="numeric"
                  style={{ width: 80 }}
            ...
            {/* 04 Risk */}
            <div className="field">
              <div style={lbl}>04 — Risk level</div>
            ...
            {/* 05 Style */}
            <div className="field">
              <div style={lbl}>05 — What do you believe in? <span style={{ fontWeight: 400, fontSize: 10, textTransform: "none", letterSpacing: 0 }}>select one or more</span></div>
            ...
            <div style={{ paddingTop: 24 }}>
              <div onClick={submit} style={{
                ...
                touchAction: "manipulation", userSelect: "none", WebkitUserSelect: "none" as const,
              }}>
